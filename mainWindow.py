...
class SheetMusic:
   ...
   #purpose: places a note at the x position of the mouse and to the closest stave line in the y direction
    ...
    #input: a txt file with the correct formate generated by the export functions
    #output: adds all the notes from the file onto the stave
    def importFile(self):
        ...
        if os.path.splitext(filename)[1] != ".txt":
                ...
                messagebox.showerror(title="Error",
                                     message="Please select a text file to import")
    ...
    #function name: export file
    #input: none
    #output: generates a txt file with note info that can then be read out by the import function
    def exportFile(self):
        ...
        with open(filePath, "w") as file:
            ...
            #sort and select the notes list, mergeSort returns a 2D list, which is why we select item [0]
            ...
            for i in range(len(sortedNotes[0])):
                ...
                #assume default accent is natural, as most likely they are
                ...
                #on every line, write down x position, y position, if the note is a rest, whatever accent the note has, and the duration
