...
class SheetMusic:
    ...
    def __init__(self):
        ...
        buttonGenerateMusic.grid(column = 9, row = 0, padx = (50,40), pady = 5)
        ...
        buttonDeleteAll.grid(column = 10, row = 0, padx = (0,40), pady = 5)


        buttonExport = Button(optionsCanvas, text = "Export", command = self.exportFile)
        buttonExport.grid(column = 11, row = 0, padx = 5, pady = 15, sticky=N)

        buttonImport = Button(optionsCanvas, text = "Import",command = self.importFile)
        buttonImport.grid(column = 11, row = 0, padx = 5, pady = (15,5), sticky=S)
